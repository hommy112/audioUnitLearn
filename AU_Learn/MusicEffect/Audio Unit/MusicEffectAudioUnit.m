//
//  MusicEffectAudioUnit.m
//  MusicEffect
//
//  Created by hanyang on 2020/12/20.
//

#import "MusicEffectAudioUnit.h"
...
@interface MusicEffectAudioUnit ()
...
@implementation MusicEffectAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[MusicEffectDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block MusicEffectDSPKernelAdapter * kernelAdapter = _kernelAdapter;
