//
//  AU_GeneraterAudioUnit.m
//  AU_Generater
//
//  Created by hanyang on 2020/12/20.
//

#import "AU_GeneraterAudioUnit.h"
...
@interface AU_GeneraterAudioUnit ()
...
@implementation AU_GeneraterAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[AU_GeneraterDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block AU_GeneraterDSPKernelAdapter * kernelAdapter = _kernelAdapter;
