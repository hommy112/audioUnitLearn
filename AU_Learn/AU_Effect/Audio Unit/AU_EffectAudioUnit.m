//
//  AU_EffectAudioUnit.m
//  AU_Effect
//
//  Created by hanyang on 2020/12/20.
//

#import "AU_EffectAudioUnit.h"
...
@implementation AU_EffectAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[AU_EffectDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block AU_EffectDSPKernelAdapter * kernelAdapter = _kernelAdapter;
